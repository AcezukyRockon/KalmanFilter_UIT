...
int main() {
    ...
    for (i=0;i<576029;i++) {
        ...
        minus = z_measured - x_est; // goc - nhieu on thap = nhieu on cao
        ...
        K = P_temp * (1.0/(P_temp + R));
        //correct
        result = x_temp_est + K * (minus - x_temp_est); // x_est = nhieu on thap
        P = (1- K) * P_temp;
        //we have our new system
        ...
        K = P_temp * (1.0/(P_temp + R));
        //correct
        result = x_temp_est + K * (result - x_temp_est); // x_est = nhieu on thap
        P = (1- K) * P_temp;
        //we have our new system
